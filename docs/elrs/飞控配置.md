...
# Betaflight配置
ELRS接收器与 FC 板的连接如下图所示

![1778812428964](image/飞控配置/1778812428964.png)

1. 打开Betaflight Configurator
2. 进在 Betaflight 配置器 “端口” 选项卡上启用相应的 UART（例如下面的 UART3）作为串行 Rx。

![1778812479071](image/飞控配置/1778812479071.png)

3. 在“配置”选项卡上，在“接收器”面板上选择“基于串行的接收器”，然后选择“CRSF”作为协议。遥测在这里是可选的，并且由于那些用于遥测的传输时隙会降低您的棒更新率。

![1778812610424](image/飞控配置/1778812610424.png)
